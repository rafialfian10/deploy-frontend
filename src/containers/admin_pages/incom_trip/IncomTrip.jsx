...
const IncomTrip = () => {
  ...
  // get data trips
  let { data: tripsAdmin, refetch: refetchTrip } = useQuery(
    "tripsAdminCache",
    async () => {
    ...
    <>
      ...
      <div className="title">
        ...
        <div className="button-add">
          <Button onClick={() => setModalApproved(true)} className="btn-incom">
            Add Country
          </Button>
          <Button onClick={() => navigate("/add_trip")} className="btn-incom">
            Add Trip
          </Button>
        </div>
      </div>
                    ...
                    <Dropdown.Menu className="dropdown-menu-trip">
                      ...
                      <Dropdown.Item
                        onClick={() => {
                          setTripId(trip.id);
                          setValue(trip);
                          handleDeleteTrip.mutate(trip.id);
                        }}
                      >
                        Delete
                      </Dropdown.Item>
